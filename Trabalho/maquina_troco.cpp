...
main() {
    ...
    while (somanotas<divida){ //Verificacao de valor introduzido em relacao a divida em curso
        ...
        cin>>notas;
        while ((notas != 5) && (notas != 10) && (notas != 20) && (notas != 50) && (notas != 100) && (notas != 200) && (notas != 500) && ((notas>='a')&&(notas<='z'))||((notas>='A') && (notas<='Z'))) { //Verificacao da nota introduzida
            cout << "Volte a introduzir o pagamento na escala de notas definidas: ";
            cin >> notas;
        }
        somanotas+=notas;
        if (somanotas<divida){ //Verificacao se ainda sera necessario introduzir notas
